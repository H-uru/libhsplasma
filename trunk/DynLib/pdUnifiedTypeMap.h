...
typedef enum _pdClassType {
    ...
    kRenderTarget, kCubicRenderTarget, kCubicRenderTargetModifier, kObjInterface,
    kAudioInterface, kAudible, kAudibleNull, kWinAudible, kCoordinateInterface,
    kDrawInterface, kDrawable, kDrawableMesh, kDrawableIce, kPhysical,
    kPhysicalMesh, kSimulationInterface, kCameraModifier, kModifier,
    kSingleModifier, kSimpleModifier, kSimpleTMModifier, kRandomTMModifier,
    kInterestingModifier, kDetectorModifier, kSimplePhysicalMesh,
    kCompoundPhysicalMesh, kMultiModifier, kSynchedObject, kSoundBuffer,
    kAliasModifier, kPickingDetector, kCollisionDetector, kLogicModifier,
    kConditionalObject, kANDConditionalObject, kORConditionalObject,
    kPickedConditionalObject, kActivatorConditionalObject, kTimerCallbackManager,
    ...
    kLocalPlayerIntersectPlaneConditionalObject, kPortalDrawable, kPortalPhysical,
    kSpawnModifier, kFacingConditionalObject, kHKPhysical, kViewFaceModifier,
    kLayerInterface, kLayerWrapper, kLayerAnimation, kLayerDepth, kLayerMovie,
    kLayerBink, kLayerAVI, kSound, kWin32Sound, kLayerOr, kAudioSystem,
    kDrawableSpans, kDrawablePatchSet, kInputManager, kLogicModBase,
    kFogEnvironment, kNetApp, kNetClientMgr, k2WayWinAudible, kLightInfo,
    kDirectionalLightInfo, kOmniLightInfo, kSpotLightInfo, kLightSpace,
    kNetClientApp, kNetServerApp, kClient, kCompoundTMModifier, kCameraBrain,
    kCameraBrain_Default, kCameraBrain_Drive, kCameraBrain_Fixed,
    ...
    kLimitedDirLightInfo, kAGAnim, kAGModifier, kAGMasterMod, kCameraBrain_Avatar,
    kCameraRegionDetector, kCameraBrain_FP, kLineFollowMod, kLightModifier,
    kOmniModifier, kSpotModifier, kLtdDirModifier, kSeekPointMod, kOneShotMod,
    kRandomCommandMod, kRandomSoundMod, kPostEffectMod, kObjectInVolumeDetector,
    kResponderModifier, kAxisAnimModifier, kLayerLightBase, kFollowMod,
    kTransitionMgr, kInventoryMod, kInventoryObjMod, kLinkEffectsMgr,
    kWin32StreamingSound, kPythonMod, kActivatorActivatorConditionalObject,
    kSoftVolume, kSoftVolumeSimple, kSoftVolumeComplex, kSoftVolumeUnion,
    kSoftVolumeIntersect, kSoftVolumeInvert, kWin32LinkSound, kLayerLinkAnimation,
    kArmatureMod, kCameraBrain_Freelook, kHavokConstraintsMod,
    kHingeConstraintMod, kWheelConstraintMod, kStrongSpringConstraintMod,
    kArmatureLODMod, kWin32StaticSound, kGameGUIMgr, kGUIDialogMod, kCameraBrain1,
    kVirtualCam1, kCameraModifier1, kCameraBrain1_Drive, kCameraBrain1_POA,
    kCameraBrain1_Avatar, kCameraBrain1_Fixed, kCameraBrain1_POAFixed,
    kGUIButtonMod, kPythonFileMod, kGUIControlMod, kExcludeRegionModifier,
    kGUIDraggableMod, kVolumeSensorConditionalObject,
    kVolActivatorConditionalObject, kMsgForwarder, kBlower, kGUIListBoxMod,
    kGUITextBoxMod, kGUIEditBoxMod, kDynamicTextMap, kSittingModifier,
    kGUIUpDownPairMod, kGUIValueCtrl, kGUIKnobCtrl, kAvLadderMod,
    kCameraBrain1_FirstPerson, kCloneSpawnModifier, kClothingItem,
    ...
    kHardRegionComplex, kHardRegionUnion, kHardRegionIntersect, kHardRegionInvert,
    kVisRegion, kVisMgr, kRegionBase, kGUIPopUpMenu, kGUIMenuItem,
    kCoopCoordinator, kFont, kFontCache, kRelevanceRegion, kRelevanceMgr,
    kJournalBook, kLayerTargetContainer, kImageLibMod, kParticleFlockEffect,
    kParticleSDLMod, kAgeLoader, kWaveSetBase, kPhysicalSndGroup, kBookData,
    kDynaTorpedoMgr, kDynaTorpedoVSMgr, kClusterGroup, kGameMarkerModifier,
    kLODMipmap, kSwimDetector, kFadeOpacityMod, kFadeOpacityLay, kDistOpacityMod,
    kArmatureModBase, kSwimRegionInterface, kSwimCircularCurrentRegion,
    kParticleFollowSystemEffect, kSwimStraightCurrentRegion, kObjectFlocker,
    kGrassShaderMod, kDynamicCamMap, kSwimRegion, kPXPhysical, kODEPhysical,
    kAutoWalkRegion, kCrossfade, kParticleFadeOutEffect, kSecurePreloader,
    kWindBoneMod, kCameraBrain_NovicePlus, kSubtitleMgr,
    ...
    kSpawnMod, kCameraBrain_Novice, kAvatarPhysicalSDLModifier, kDirectMusicSound,
    kClientSessionMgr, kSDLVarChangeNotifier, kInterestWellModifier,
    kElevatorModifier, kCameraBrain_Expert, kPagingRegionModifier,
    kGuidepathModifier, kNodeMgr, kEAXEffect, kEAXPitchShifter, kIKModifier,
    kCameraBrain_M5, kAGAnimBink, kTreeShader, kNodeRegionModifier,
    kPiranhaRegionModifier,
    ...
    kAvTaskSeekDoneMsg, kAvatarSpawnNotifyMsg, kNetServerMsgVaultTask,
    ...
    kVaultAgeInfoInitializationTask, kGameGUIMsg,
    kNetServerMsgVaultRequestGameState, kNetServerMsgVaultGameState,
    kNetServerMsgVaultGameStateSave, kNetServerMsgVaultGameStateSaved,
    kNetServerMsgVaultGameStateLoad, kNetClientTask, kNetMsgSDLStateBCast,
    kReplaceGeometryMsg, kNetServerMsgExitProcess, kNetServerMsgSaveGameState,
    kDniCoordinateInfo, kNetMsgGameMessageDirected, kLinkOutUnloadMsg,
    kScalarConstant, kMatrixConstant, kAGCmdMsg, kParticleTransferMsg,
    kParticleKillMsg, kExcludeRegionMsg, kOneTimeParticleGenerator,
    kParticleApplicator, kParticleLifeMinApplicator, kParticleLifeMaxApplicator,
    ...
    kElementRefMsg, kClothingMsg, kEventGroupEnableMsg, kGUINotifyMsg,
    kAvBrain, kArmatureBrain, kAvBrainHuman, kAvBrainCritter, kAvBrainDrive,
    kAvBrainSample, kAvBrainGeneric, kAvBrainPuppet, kAvBrainLadder,
    kInputIfaceMgrMsg, kKIMsg, kRemoteAvatarInfoMsg,
    ...
    kNetServerMsgVaultDeletePlayer, kNetCoreStatsSummary, kCreatableGenericValue,
    kCreatableListHelper, kCreatableStream, kAvBrainGenericMsg, kAvTaskSeek,
    kAGInstanceCallbackMsg, kArmatureEffectMsg, kArmatureEffectStateMsg,
    kShadowCastMsg, kBoundsIsect, kNetClientCommLeaveTask, kResMgrHelperMsg,
    kNetMsgAuthenticateResponse, kNetMsgAccountAuthenticated,
    kNetClientCommSendPeriodicAliveTask, kNetClientCommCheckServerSilenceTask,
    kNetClientCommPingTask, kNetClientCommFindAgeTask,
    kNetClientCommSetActivePlayerTask, kNetClientCommGetPlayerListTask,
    kNetClientCommCreatePlayerTask, kNetClientCommJoinAgeTask,
    kVaultAdminInitializationTask, kMultistageModMsg, kSoundVolumeApplicator,
    kCutter, kBulletMsg, kDynaDecalEnableMsg, kOmniCutoffApplicator,
    kArmatureUpdateMsg, kAvatarFootMsg, kNetOwnershipMsg,
    ...
    kSDLStoreMsg, kOmniSqApplicator, kUNUSED_DynamicScalar,
    kUNUSED_DynamicColorRGB, kUNUSED_DynamicMatrix33, kUNUSED_DynamicMatrix44,
    kCompoundController, kNetClientMgrMsg, kAgeLoaderMsg, kAvBrainAvatar,
    kPythonNotifyMsg, kNCAgeJoinerMsg, kAvTaskDumbSeek, kAvTaskSmartSeek,
    kCreatableUuid, kPreloaderMsg, kNetCommAuthConnectedMsg, kNetCommAuthMsg,
    ...
    kVaultSystemNode, kAvBrainSwim, kNetMsgVault, kNetServerMsgVault, kVaultTask,
    kVaultConnectTask, kVaultNegotiateManifestTask, kVaultFetchNodesTask,
    kVaultSaveNodeTask, kVaultFindNodeTask, kVaultAddNodeRefTask,
    kVaultRemoveNodeRefTask, kVaultSendNodeTask,
    ...
    kBackdoorMsg, kNetMsgPython, kPythonMsg, kStateDataRecord,
    kNetClientCommDeletePlayerTask, kNetMsgSetTimeout, kNetMsgActivePlayerSet,
    kNetClientCommSetTimeoutTask, kNetRoutableMsgOmnibus,
    kNetMsgGetPublicAgeList, kNetMsgPublicAgeList, kNetMsgCreatePublicAge,
    kNetMsgPublicAgeCreated, kNetServerMsgEnvelope,
    ...
    kSDLFixedArrayQuaternionVar, kSDLFixedArrayMatrix44Var, kSDLFixedArrayRGBAVar,
    kSDLDynArrayStructVar, kSDLDynArrayBoolVar, kSDLDynArrayCharVar,
    kSDLDynArrayByteVar, kSDLDynArrayIntVar, kSDLDynArrayUIntVar,
    kSDLDynArrayFloatVar, kSDLDynArrayDoubleVar, kSDLDynArrayStringVar,
    kSDLDynArrayTimeVar, kSDLDynArrayUoidVar, kSDLDynArrayVector3Var,
    kSDLDynArrayPoint3Var, kSDLDynArrayQuaternionVar, kSDLDynArrayMatrix44Var,
    kSDLDynArrayRGBAVar, kSDLArrayVar, kSDLVarChangeMsg, kAvBrainPath,
    kSDLBufferVar, kSDLFixedArrayBufferVar, kSDLDynArrayBufferVar,
    kMatrixBorrowedChannel, kNodeRegionMsg, kEventCallbackSetupMsg,
    kRelativeMatrixChannelApplicator, kPiranhaRegionMsg, kGameMgrMsg, kGameCliMsg,
    kGameCli, kGmTicTacToe, kGmHeek, kGmMarker, kGmBlueSpiral, kAccountUpdateMsg
} pdClassType;

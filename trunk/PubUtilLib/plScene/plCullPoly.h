...
public:
  ...
  class plCullPoly & plCullPoly::Init(const class plCullPoly &);
  class plCullPoly & plCullPoly::Flip(const class plCullPoly &);
  class plCullPoly & plCullPoly::InitFromVerts(unsigned long);
  float plCullPoly::ICalcRadius();
  class plCullPoly & plCullPoly::Transform(const struct hsMatrix44 &, const struct hsMatrix44 &, class plCullPoly &);
  ...
  plCullPoly(const class plCullPoly &);

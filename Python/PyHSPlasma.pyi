...
class pfGUIControlMod(plSingleModifier):
    ...
    dynTextLayer: Optional[plKey] = ...
    dynTextMap: Optional[plKey] = ...
...
class pfGUIDialogMod(plSingleModifier):
    ...
    renderMod: Optional[plKey] = ...
    sceneNode: Optional[plKey] = ...
    tagID: int = ...
    version: int = ...
...
class pfGUIPopUpMenu(pfGUIDialogMod):
    ...
    alignment: int = ...
    margin: int = ...
    originAnchor: Optional[plKey] = ...
    originContext: Optional[plKey] = ...
    skin: Optional[plKey] = ...
...
class pfGUIUpDownPairMod(pfGUIValueCtrl):
    downControl: Optional[plKey] = ...
    upControl: Optional[plKey] = ...
...
class plCameraBrain1_Circle(plCameraBrain1_Fixed):
    ...
    center: hsVector3 = ...
    centerObject: Optional[plKey] = ...
    cirPerSec: float = ...
    circleFlags: int = ...
    poaObject: Optional[plKey] = ...
    radius: float = ...
...
class plCameraModifier(plSingleModifier):
    class CamTrans:
        ...
        poaDecl: float = ...
        poaVelocity: float = ...
        transTo: Optional[plKey] = ...
        velocity: float = ...

    animated: bool = ...
    at: hsVector3 = ...
    brain: Optional[plKey] = ...
    fovH: float = ...
...
class plDynaDecalMgr(plSynchedObject):
    ...
    intensity: float = ...
    lifeSpan: float = ...
    matPreShade: Optional[plKey] = ...
    matRTShade: Optional[plKey] = ...
    maxNumIdx: int = ...
    maxNumVerts: int = ...
...
class plDynamicCamMap(plRenderTarget):
    camera: Optional[plKey] = ...
    color: hsColorRGBA = ...
    disableTexture: Optional[plKey]  = ...
    fogStart: float = ...
    hither: float = ...
    incCharacters: bool = ...
    matLayers: Sequence[plKey] = ...
    refreshRate: float = ...
    rootNode: Optional[plKey]  = ...
...
class plLayerInterface(plSynchedObject):
    ...
    underLay: Optional[plKey] = ...
    vertexShader: Optional[plKey] = ...

class plLayerLinkAnimation(plLayerAnimation):
    leavingAge: bool = ...
    linkKey: Optional[plKey] = ...
...
class plLightInfo(plObjInterface):
    ...
    projection: Optional[plKey] = ...
    sceneNode: Optional[plKey] = ...
    softVolume: Optional[plKey] = ...
    specular: hsColorRGBA = ...
    visRegions: Sequence[plKey] = ...
...
class plLineFollowMod(plMultiModifier):
    ...
    pathParent: Optional[plKey] = ...
    refObj: Optional[plKey] = ...
    speedClamp: float = ...
...
class plSceneObject(plSynchedObject):
    audio: Optional[plKey] = ...
    coord: Optional[plKey] = ...
    draw: Optional[plKey] = ...
...
class plSound(plSynchedObject):
    ...
    priority: int = ...
    properties: int = ...
    softOcclusionRegion: Optional[plKey] = ...
    softRegion: Optional[plKey] = ...
    subtitleId: str = ...
    time: float = ...
    type: int = ...

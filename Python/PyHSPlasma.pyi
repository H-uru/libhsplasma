...
class plAxisAnimModifier(plSingleModifier):
    allOrNothing: bool = ...
    animLabel: str = ...
    notificationKey: Optional[plKey[plLogicModifier]] = ...
    notify: Optional[plNotifyMsg] = ...
    XAnim: Optional[plKey[plAGMasterMod]] = ...
    YAnim: Optional[plKey[plAGMasterMod]] = ...

...
PyTypeObject pyResponderMsg_Type = {
    ...
    "PyHSPlasma.plResponderMsg",        /* tp_name */
    sizeof(pyResponderMsg),             /* tp_basicsize */
    0,                                  /* tp_itemsize */
...
PyObject* Init_pyResponderMsg_Type() {
    ...
    if (PyType_Ready(&pyResponderMsg_Type) < 0)
        return NULL;

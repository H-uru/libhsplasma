...
PyTypeObject pySwimDetector_Type = {
    ...
    "PyHSPlasma.plSwimDetector",        /* tp_name */
    sizeof(pySwimDetector),             /* tp_basicsize */
    0,                                  /* tp_itemsize */
...
PyObject* Init_pySwimDetector_Type() {
    pySwimDetector_Type.tp_base = &pySimpleRegionSensor_Type;
    if (PyType_Ready(&pySwimDetector_Type) < 0)
        return NULL;

...
PyTypeObject pyWin32StreamingSound_Type = {
    ...
    "PyHSPlasma.plWin32StreamingSound", /* tp_name */
    sizeof(pyWin32StreamingSound),      /* tp_basicsize */
    0,                                  /* tp_itemsize */
    ...
    "plWin32StreamingSound wrapper",          /* tp_doc */
    ...
    NULL,                               /* tp_init */
    NULL,                               /* tp_alloc */
    pyWin32StreamingSound_new,          /* tp_new */
    NULL,                               /* tp_free */
    NULL,                               /* tp_is_gc */
...
PyObject* Init_pyWin32StreamingSound_Type() {
    ...
    if (PyType_Ready(&pyWin32StreamingSound_Type) < 0)
        return NULL;

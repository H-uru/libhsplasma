...
static PyObject* pyAudibleNull_Convert(PyObject*, PyObject* args) {
    pyCreatable* cre;
...
static PyMethodDef pyAudibleNull_Methods[] = {
    { "Convert", (PyCFunction)pyAudibleNull_Convert, METH_VARARGS | METH_STATIC,
      "Convert a Creatable to a plAudibleNull" },
    { NULL, NULL, 0, NULL }
};

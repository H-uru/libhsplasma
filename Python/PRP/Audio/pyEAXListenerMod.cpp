...
PY_PROPERTY_MEMBER(uint32_t, EAXReverbProperties, environment, ulEnvironment)
...
PY_PROPERTY_MEMBER(int32_t, EAXReverbProperties, room, lRoom)
PY_PROPERTY_MEMBER(int32_t, EAXReverbProperties, roomHF, lRoomHF)
PY_PROPERTY_MEMBER(int32_t, EAXReverbProperties, roomLF, lRoomLF)
...
PY_PROPERTY_MEMBER(int32_t, EAXReverbProperties, reflections, lReflections)
PY_PROPERTY_MEMBER(float, EAXReverbProperties, reflectionsDelay, flReflectionsDelay)
PY_PROPERTY_MEMBER(int32_t, EAXReverbProperties, reverb, lReverb)
...
PY_PROPERTY_MEMBER(uint32_t, EAXReverbProperties, flags, ulFlags)

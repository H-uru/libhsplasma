...
static PyObject* pySingleModifier_setFlag(pySingleModifier* self, PyObject* args) {
    int flag;
    if (!PyArg_ParseTuple(args, "i", &flag)) {
        PyErr_SetString(PyExc_TypeError, "getFlag expects an int");
        return NULL;
...
static PyObject* pySingleModifier_clearFlag(pySingleModifier* self, PyObject* args) {
    int flag;
    if (!PyArg_ParseTuple(args, "i", &flag)) {
...
static PyMethodDef pySingleModifier_Methods[] = {
    ...
    { "clearFlag", (PyCFunction)pySingleModifier_clearFlag, METH_VARARGS,
      "Params: flag\n"

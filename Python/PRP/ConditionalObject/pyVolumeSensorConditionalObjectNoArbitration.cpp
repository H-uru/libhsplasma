...
PyTypeObject pyVolumeSensorConditionalObjectNoArbitration_Type = {
    ...
    "PyHSPlasma.plVolumeSensorConditionalObjectNoArbitration", /* tp_name */
    sizeof(pyVolumeSensorConditionalObjectNoArbitration),      /* tp_basicsize */
    0,                                                         /* tp_itemsize */
    ...
    "plVolumeSensorConditionalObjectNoArbitration wrapper", /* tp_doc */
    ...
    NULL,                               /* tp_init */
    NULL,                               /* tp_alloc */
    pyVolumeSensorConditionalObjectNoArbitration_new, /* tp_new */
    NULL,                               /* tp_free */
    NULL,                               /* tp_is_gc */
...
PyObject* Init_pyVolumeSensorConditionalObjectNoArbitration_Type() {
    ...
    if (PyType_Ready(&pyVolumeSensorConditionalObjectNoArbitration_Type) < 0)
        return NULL;

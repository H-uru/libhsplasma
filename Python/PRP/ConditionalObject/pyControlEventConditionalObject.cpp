...
PyTypeObject pyControlEventConditionalObject_Type = {
    ...
    "PyHSPlasma.plControlEventConditionalObject", /* tp_name */
    sizeof(pyControlEventConditionalObject),      /* tp_basicsize */
    0,                                            /* tp_itemsize */
    ...
    "plControlEventConditionalObject wrapper", /* tp_doc */
    ...
    NULL,                                   /* tp_methods */
    NULL,                                   /* tp_members */
    pyControlEventConditionalObject_GetSet, /* tp_getset */
    NULL,                                   /* tp_base */
    NULL,                                   /* tp_dict */
    NULL,                                   /* tp_descr_get */
    NULL,                                   /* tp_descr_set */
    ...
    NULL,                               /* tp_init */
    NULL,                               /* tp_alloc */
    pyControlEventConditionalObject_new,/* tp_new */
    NULL,                               /* tp_free */
    NULL,                               /* tp_is_gc */

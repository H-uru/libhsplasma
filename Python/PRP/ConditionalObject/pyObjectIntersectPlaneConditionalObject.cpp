...
static PyObject* pyObjectIntersectPlaneConditionalObject_new(PyTypeObject* type, PyObject* args, PyObject* kwds) {
    pyObjectIntersectPlaneConditionalObject* self = (pyObjectIntersectPlaneConditionalObject*)type->tp_alloc(type, 0);
    if (self != NULL) {
        self->fThis = new plObjectIntersectPlaneConditionalObject();
        self->fPyOwned = true;
    }
    return (PyObject*)self;
}

PyTypeObject pyObjectIntersectPlaneConditionalObject_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    "PyHSPlasma.plObjectIntersectPlaneConditionalObject", /* tp_name */
    sizeof(pyObjectIntersectPlaneConditionalObject),      /* tp_basicsize */
    0,                                                    /* tp_itemsize */
    ...
    "plObjectIntersectPlaneConditionalObject wrapper", /* tp_doc */
    ...
    NULL,                               /* tp_init */
    NULL,                               /* tp_alloc */
    pyObjectIntersectPlaneConditionalObject_new, /* tp_new */
    NULL,                               /* tp_free */
    NULL,                               /* tp_is_gc */
...
PyObject* Init_pyObjectIntersectPlaneConditionalObject_Type() {
    ...
    if (PyType_Ready(&pyObjectIntersectPlaneConditionalObject_Type) < 0)
        return NULL;

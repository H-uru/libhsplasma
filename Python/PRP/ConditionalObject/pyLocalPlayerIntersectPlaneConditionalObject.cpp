...
PyTypeObject pyLocalPlayerIntersectPlaneConditionalObject_Type = {
    ...
    "PyHSPlasma.plLocalPlayerIntersectPlaneConditionalObject", /* tp_name */
    sizeof(pyLocalPlayerIntersectPlaneConditionalObject),      /* tp_basicsize */
    0,                                                         /* tp_itemsize */
    ...
    "plLocalPlayerIntersectPlaneConditionalObject wrapper", /* tp_doc */
    ...
    NULL,                               /* tp_init */
    NULL,                               /* tp_alloc */
    pyLocalPlayerIntersectPlaneConditionalObject_new, /* tp_new */
    NULL,                               /* tp_free */
    NULL,                               /* tp_is_gc */
...
PyObject* Init_pyLocalPlayerIntersectPlaneConditionalObject_Type() {
    ...
    if (PyType_Ready(&pyLocalPlayerIntersectPlaneConditionalObject_Type) < 0)
        return NULL;
...
int pyLocalPlayerIntersectPlaneConditionalObject_Check(PyObject* obj) {
    if (obj->ob_type == &pyLocalPlayerIntersectPlaneConditionalObject_Type
        || PyType_IsSubtype(obj->ob_type, &pyLocalPlayerIntersectPlaneConditionalObject_Type))
        return 1;
    return 0;
}
...
PyObject* pyLocalPlayerIntersectPlaneConditionalObject_FromLocalPlayerIntersectPlaneConditionalObject(class plLocalPlayerIntersectPlaneConditionalObject* obj) {
    ...
    pyLocalPlayerIntersectPlaneConditionalObject* py = PyObject_New(pyLocalPlayerIntersectPlaneConditionalObject, &pyLocalPlayerIntersectPlaneConditionalObject_Type);
    py->fThis = obj;
    py->fPyOwned = false;
    return (PyObject*)py;
}

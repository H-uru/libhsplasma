...
static PyObject* pyLightAmbientApplicator_Convert(PyObject*, PyObject* args) {
    pyCreatable* cre;
...
static PyMethodDef pyLightAmbientApplicator_Methods[] = {
    { "Convert", (PyCFunction)pyLightAmbientApplicator_Convert, METH_VARARGS | METH_STATIC,
      "Convert a Creatable to a plLightAmbientApplicator" },
    { NULL, NULL, 0, NULL }
};
...
PyTypeObject pyLightAmbientApplicator_Type = {
    ...
    "plLightAmbientApplicator wrapper", /* tp_doc */
    ...
    NULL,                               /* tp_init */
    NULL,                               /* tp_alloc */
    pyLightAmbientApplicator_new,       /* tp_new */
    NULL,                               /* tp_free */
    NULL,                               /* tp_is_gc */

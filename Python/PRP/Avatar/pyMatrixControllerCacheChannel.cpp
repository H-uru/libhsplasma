...
static PyObject* pyMatrixControllerCacheChannel_Convert(PyObject*, PyObject* args) {
    pyCreatable* cre;
...
static PyMethodDef pyMatrixControllerCacheChannel_Methods[] = {
    { "Convert", (PyCFunction)pyMatrixControllerCacheChannel_Convert, METH_VARARGS | METH_STATIC,
      "Convert a Creatable to a plMatrixControllerCacheChannel" },
    { NULL, NULL, 0, NULL }
};

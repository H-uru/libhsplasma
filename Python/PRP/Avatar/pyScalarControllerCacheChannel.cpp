...
static PyObject* pyScalarControllerCacheChannel_Convert(PyObject*, PyObject* args) {
    pyCreatable* cre;
    ...
    return pyScalarControllerCacheChannel_FromScalarControllerCacheChannel(plScalarControllerCacheChannel::Convert(IConvert(cre)));
}

static PyMethodDef pyScalarControllerCacheChannel_Methods[] = {
    { "Convert", (PyCFunction)pyScalarControllerCacheChannel_Convert, METH_VARARGS | METH_STATIC,
      "Convert a Creatable to a plScalarControllerCacheChannel" },
    { NULL, NULL, 0, NULL }
};
...
PyTypeObject pyScalarControllerCacheChannel_Type = {
    ...
    "plScalarControllerCacheChannel wrapper",            /* tp_doc */
    ...
    pyScalarControllerCacheChannel_Methods,              /* tp_methods */
    NULL,                               /* tp_members */
    NULL,                               /* tp_getset */
    NULL,                               /* tp_base */
    NULL,                               /* tp_dict */
    ...
    NULL,                               /* tp_init */
    NULL,                               /* tp_alloc */
    pyScalarControllerCacheChannel_new,                  /* tp_new */
    NULL,                               /* tp_free */
    NULL,                               /* tp_is_gc */
...
PyObject* Init_pyScalarControllerCacheChannel_Type() {
    ...
    if (PyType_Ready(&pyScalarControllerCacheChannel_Type) < 0)
        return NULL;
...
int pyScalarControllerCacheChannel_Check(PyObject* obj) {
    if (obj->ob_type == &pyScalarControllerCacheChannel_Type
        || PyType_IsSubtype(obj->ob_type, &pyScalarControllerCacheChannel_Type))
        return 1;
    return 0;
}

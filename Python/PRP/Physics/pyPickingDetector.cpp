...
PyTypeObject pyPickingDetector_Type = {
    ...
    "PyHSPlasma.plPickingDetector",     /* tp_name */
    sizeof(pyPickingDetector),          /* tp_basicsize */
    0,                                  /* tp_itemsize */
    ...
    "plPickingDetector wrapper",        /* tp_doc */
...
PyObject* Init_pyPickingDetector_Type() {
    ...
    if (PyType_Ready(&pyPickingDetector_Type) < 0)
        return NULL;

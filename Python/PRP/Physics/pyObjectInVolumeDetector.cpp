...
PyTypeObject pyObjectInVolumeDetector_Type = {
    ...
    "PyHSPlasma.plObjectInVolumeDetector", /* tp_name */
    sizeof(pyObjectInVolumeDetector),      /* tp_basicsize */
    0,                                     /* tp_itemsize */
    ...
    "plObjectInVolumeDetector wrapper",       /* tp_doc */
    ...
    NULL,                               /* tp_init */
    NULL,                               /* tp_alloc */
    pyObjectInVolumeDetector_new,       /* tp_new */
    NULL,                               /* tp_free */
    NULL,                               /* tp_is_gc */
...
PyObject* Init_pyObjectInVolumeDetector_Type() {
    ...
    if (PyType_Ready(&pyObjectInVolumeDetector_Type) < 0)
        return NULL;

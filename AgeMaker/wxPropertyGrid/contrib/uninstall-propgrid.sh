...
rm -f samples/propgrid/makefile.2.7.2.bcc
rm -f samples/propgrid/makefile.2.7.2.gcc
rm -f samples/propgrid/Makefile.2.7.2.in
rm -f samples/propgrid/makefile.2.7.2.vc
rm -f samples/propgrid/makefile.2.7.2.wat
...
rm -f samples/propgrid/propgridsample.2.7.2.dsp
rm -f samples/propgrid/propgridsample.2.7.2.dsw
...
rm -f build/propgrid/makefile.2.7.2.bcc
rm -f build/propgrid/makefile.2.7.2.gcc
rm -f build/propgrid/makefile.2.7.2.vc
rm -f build/propgrid/makefile.2.7.2.wat
...
rm -f build/propgrid/propgrid.2.7.2.dsp
rm -f build/propgrid/propgrid.2.7.2.dsw
...
rm -f src/propgrid/Makefile.2.7.2.in

...
public:
  ...
  void plSpaceTree::HarvestLeaves(short, hsTArray<short> &);
  void plSpaceTree::HarvestLeaves(class plVolumeIsect *, hsTArray<short> &);
  void plSpaceTree::HarvestLeaves(hsTArray<short> &);
  ...
  void plSpaceTree::EnableLeaves(const hsTArray<short> &, class hsBitVector &);
  void plSpaceTree::HarvestEnabledLeaves(class plVolumeIsect *, const class hsBitVector &, hsTArray<short> &);
  void plSpaceTree::SetCache(const class hsBitVector *);
  void plSpaceTree::BitVectorToList(hsTArray<short> &, const class hsBitVector &);
  ...
  void plSpaceTree::HarvestLevel(int, hsTArray<short> &);
...
private:
  ...
  void plSpaceTree::IHarvestAndCullLeaves(const class plSpaceTreeNode &, hsTArray<short> &);
  void plSpaceTree::IHarvestLeaves(const class plSpaceTreeNode &, class hsBitVector &, class hsBitVector &);
  void plSpaceTree::IHarvestLeaves(const class plSpaceTreeNode &, hsTArray<short> &);
  void plSpaceTree::IHarvestLevel(short, int, int, hsTArray<short> &);
  void plSpaceTree::IHarvestAndCullEnabledLeaves(short, const class hsBitVector &, hsTArray<short> &);
  void plSpaceTree::IHarvestEnabledLeaves(short, const class hsBitVector &, class hsBitVector &, class hsBitVector &);
  void plSpaceTree::IHarvestEnabledLeaves(short, const class hsBitVector &, hsTArray<short> &);

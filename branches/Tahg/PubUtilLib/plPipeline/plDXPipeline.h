...
class plDXLightSettings {
  class hsBitVector fUsedFlags; //this+0x0
  class hsBitVector fEnabledFlags; //this+0xc
  class hsBitVector fHoldFlags; //this+0x18
  unsigned long fNextIndex; //this+0x24
  unsigned long fLastIndex; //this+0x28
  unsigned short fTime; //this+0x2c
  class plLightInfo * fActiveList; //this+0x30
  class plDXLightRef * fRefList; //this+0x34
  class plDXPipeline * fPipeline; //this+0x38
  hsTArray<plLightInfo *> fProjEach; //this+0x3c
  hsTArray<plLightInfo *> fProjAll; //this+0x44
  hsTArray<plLightInfo *> fCharLights; //this+0x4c
  hsTArray<plLightInfo *> fVisLights; //this+0x54
  unsigned long fNextShadowLight; //this+0x5c
  hsTArray<plDXLightRef *> fShadowLights; //this+0x60

public:
  plDXLightSettings(const class plDXLightSettings &){}
  plDXLightSettings::plDXLightSettings(){}
  void plDXLightSettings::Reset(class plDXPipeline *){}
  void plDXLightSettings::Release(){}
  unsigned long plDXLightSettings::ReserveD3DIndex(){}
  void plDXLightSettings::ReleaseD3DIndex(unsigned long){}
  plDXLightSettings::~plDXLightSettings(){}
};
...
class plDXPipeline : public plPipeline {
  ...
  struct IDirect3DSurface9 * fSharedDepthSurface[2]; //this+0x30
  enum _D3DFORMAT fSharedDepthFormat[2]; //this+0x38
  ...
  hsTArray<plCullPoly const *> fCullPolys; //this+0x280
  hsTArray<plCullPoly const *> fCullHoles; //this+0x288
  ...
  hsGMatState fMatOverOn; //this+0x2cc
  class hsGMatState fMatOverOff; //this+0x2e0
  hsTArray<hsGMaterial *> fOverrideMat; //this+0x2f4
  ...
  hsTArray<plLayerInterface *> fOverLayerStack; //this+0x3d0
  class plLayerInterface * fOverBaseLayer; //this+0x3d8
  class plLayerInterface * fOverAllLayer; //this+0x3dc
  hsTArray<plLayerInterface *> fPiggyBackStack; //this+0x3e0
  ...
  class hsGDeviceRef * fLayerRef[8]; //this+0x400
  class hsGMatState fLayerState[8]; //this+0x420
  class hsGMatState fOldLayerState[8]; //this+0x4c0
  unsigned long fLayerTransform[8]; //this+0x560
  float fLayerLODBias[8]; //this+0x580
  unsigned long fLayerUVWSrcs[8]; //this+0x5a0
  unsigned long fLayerXformFlags[8]; //this+0x5c0
  ...
  plDXFogSettings fCurrFog; //this+0x91c
  plDXLightSettings fLights; //this+0x948
  hsTArray<plShadowSlave *> fShadows; //this+0x9b0
  hsTArray<plRenderTarget *> fRenderTargetPool512; //this+0x9b8
  hsTArray<plRenderTarget *> fRenderTargetPool256; //this+0x9c0
  hsTArray<plRenderTarget *> fRenderTargetPool128; //this+0x9c8
  hsTArray<plRenderTarget *> fRenderTargetPool64; //this+0x9d0
  hsTArray<plRenderTarget *> fRenderTargetPool32; //this+0x9d8
  unsigned long fRenderTargetNext[10]; //this+0x9e0
  class plDXTextureRef * fULutTextureRef; //this+0xa08
  class plRenderTarget * fBlurScratchRTs[10]; //this+0xa0c
  class plRenderTarget * fBlurDestRTs[10]; //this+0xa34
  struct IDirect3DVertexBuffer9 * fBlurVBuffers[10]; //this+0xa5c
  unsigned long fBlurVSHandle; //this+0xa84
  hsTArray<plClothingOutfit *> fClothingOutfits; //this+0xa88
  class plDrawableSpans * fBoundsSpans; //this+0xa90
  class hsGMaterial * fBoundsMat; //this+0xa94
  hsTArray<unsigned long> fBSpansToDelete; //this+0xa98
  class plStatusLogDrawer * fLogDrawer; //this+0xaa0
  int fVSync; //this+0xaa4
  int fForceDeviceReset; //this+0xaa8

public:
  plDXPipeline(const class plDXPipeline &){}
  plDXPipeline::plDXPipeline(struct HWND__ *, const class hsG3DDeviceModeRecord *){}
  ...
  int plDXPipeline::PreRender(class plDrawable *, hsTArray<short> &, class plVisMgr *){}
  int plDXPipeline::PrepForRender(class plDrawable *, hsTArray<short> &, class plVisMgr *){}
  void plDXPipeline::Render(class plDrawable *, const hsTArray<short> &){}
  ...
  unsigned long plDXPipeline::HarvestVisible(class plSpaceTree *, hsTArray<short> &){}
  unsigned long plDXPipeline::SubmitOccluders(const hsTArray<plCullPoly const *> &){}
  ...
  int ManagedAlloced(){}
  void plDXPipeline::GetSupportedColorDepths(hsTArray<int> &){}
...
protected:
  ...
  void plDXPipeline::IGetVisibleSpans(class plDrawableSpans *, hsTArray<short> &, class plVisMgr *){}
  void plDXPipeline::IRenderSpans(class plDrawableSpans *, const hsTArray<short> &){}
  ...
  void plDXPipeline::ICheckLighting(class plDrawableSpans *, hsTArray<short> &, class plVisMgr *){}
  ...
  int plDXPipeline::IAvatarSort(class plDrawableSpans *, const hsTArray<short> &){}
  ...
  int plDXPipeline::ISoftwareVertexBlend(class plDrawableSpans *, const hsTArray<short> &){}
  ...
  void plDXPipeline::IAttachSlaveToReceivers(int, class plDrawableSpans *, const hsTArray<short> &){}
  void plDXPipeline::IAttachShadowsToReceivers(class plDrawableSpans *, const hsTArray<short> &){}

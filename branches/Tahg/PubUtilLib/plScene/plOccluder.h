...
public:
  ...
  virtual unsigned short plOccluder::ClassIndex();
  ...
  class plDrawableSpans * plOccluder::CreateProxy(class hsGMaterial *, hsTArray<unsigned long> &, class plDrawableSpans *);

...
static pnNetMsgField Cli2Auth_AcctLoginRequest_Fields[] = {
    ...
    { kFieldString,    64, sizeof(NCchar_t) },  // Account Name
    { kFieldRawData,   20, sizeof(hsUbyte)  },  // Password Hash
    { kFieldString,    64, sizeof(NCchar_t) },  // Auth Token
    { kFieldString,     8, sizeof(NCchar_t) },  // OS
};
...
static pnNetMsgField Cli2Auth_PlayerCreateRequest_Fields[] = {
    { kFieldInteger,    0, sizeof(hsUint32) },  // Trans ID
    { kFieldString,    40, sizeof(NCchar_t) },  // Player Name
    { kFieldString,   260, sizeof(NCchar_t) },  // Avatar Shape
    { kFieldString,   260, sizeof(NCchar_t) },  // Friend Invite
};
...
static pnNetMsgField Cli2Auth_SendFriendInviteRequest_Fields[] = {
    ...
    { kFieldString,    64, sizeof(NCchar_t) },  // Email address
    { kFieldString,    40, sizeof(NCchar_t) },  // To Name
};
...
static pnNetMsgField Cli2Auth_VaultInitAgeRequest_Fields[] = {
    ...
    { kFieldString,   260, sizeof(NCchar_t) },  // Age Filename
    { kFieldString,   260, sizeof(NCchar_t) },  // Age Instance Name
    { kFieldString,   260, sizeof(NCchar_t) },  // Age User Name
    { kFieldString,  1024, sizeof(NCchar_t) },  // Age Description
...
static pnNetMsgField Cli2Auth_AgeRequest_Fields[] = {
    { kFieldInteger,    0, sizeof(hsUint32) },  // Trans ID
    { kFieldString,    40, sizeof(NCchar_t) },  // Age Name
...
static pnNetMsgField Cli2Auth_FileListRequest_Fields[] = {
    { kFieldInteger,    0, sizeof(hsUint32) },  // Trans ID
    { kFieldString,   260, sizeof(NCchar_t) },  // Directory
    { kFieldString,   256, sizeof(NCchar_t) },  // Extension
};
MAKE_NETMSG(Cli2Auth_FileListRequest)

static pnNetMsgField Cli2Auth_FileDownloadRequest_Fields[] = {
    { kFieldInteger,    0, sizeof(hsUint32) },  // Trans ID
    { kFieldString,   260, sizeof(NCchar_t) },  // File Name
};
...
static pnNetMsgField Cli2Auth_GetPublicAgeList_Fields[] = {
    { kFieldInteger,    0, sizeof(hsUint32) },  // Trans ID
    { kFieldString,    64, sizeof(NCchar_t) },  // Age Filename
};
...
static pnNetMsgField Cli2Auth_ScoreCreate_Fields[] = {
    { kFieldInteger,    0, sizeof(hsUint32) },  // Trans ID
    { kFieldInteger,    0, sizeof(hsUint32) },  // Owner ID
    { kFieldString,    64, sizeof(NCchar_t) },  // Game Name
...
static pnNetMsgField Auth2Cli_AcctPlayerInfo_Fields[] = {
    ...
    { kFieldInteger,    0, sizeof(hsUint32) },  // Player ID
    { kFieldString,    40, sizeof(NCchar_t) },  // Player Name
    { kFieldString,    64, sizeof(NCchar_t) },  // Avatar Model
...
static pnNetMsgField Auth2Cli_FileListReply_Fields[] = {
    { kFieldInteger,    0, sizeof(hsUint32) },  // Trans ID
    { kFieldInteger,    0, sizeof(hsUint32) },  // Result
    { kFieldVarCount,   0, sizeof(NCchar_t) },  // List Data
    { kFieldVarPtr,     0, 0                },
};

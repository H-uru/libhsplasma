...
void plSpan::setMaxBoneIdx(unsigned short idx) { fMaxBoneIdx = idx; }
void plSpan::setPenBoneIdx(unsigned short idx) { fPenBoneIdx = idx; }
void plSpan::setLocalUVWChans(unsigned short chans) { fLocalUVWChans = chans; }
